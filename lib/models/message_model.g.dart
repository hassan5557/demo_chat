...
MessageModel _messageModelDeserialize(
  ...
  object.groupId = reader.readStringOrNull(offsets[3]);
  object.id = id;
  object.receiverId = reader.readStringOrNull(offsets[4]);
  object.senderEmail = reader.readStringOrNull(offsets[5]);
...
extension MessageModelQueryWhere
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> chatIdEqualTo(
      String chatId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> chatIdNotEqualTo(
      String chatId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> groupIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'groupId',
        value: [null],
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> groupIdEqualTo(
      String? groupId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'groupId',
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterWhereClause> groupIdNotEqualTo(
      String? groupId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension MessageModelQuerySortBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortBySenderEmail() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortBySupabaseId() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageModelQuerySortThenBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenBySenderEmail() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'senderEmail', Sort.asc);
    });
  }
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenBySupabaseId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'supabaseId', Sort.asc);
    });
  }
...
extension MessageModelQueryWhereDistinct
  ...
  QueryBuilder<MessageModel, MessageModel, QDistinct> distinctBySenderEmail(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageModel, QDistinct> distinctBySupabaseId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageModelQueryProperty
  ...
  QueryBuilder<MessageModel, String?, QQueryOperations> senderEmailProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, String?, QQueryOperations> supabaseIdProperty() {
    return QueryBuilder.apply(this, (query) {
